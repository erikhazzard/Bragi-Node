...
LOGGER.options = {
    ...
    // This is a property that users should never need to care about - only used
    // for internal debugging / inspection. Will show Bragi specific logs
    _showBragiLogs: false,
};
