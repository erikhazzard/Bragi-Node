...
function TransportConsole ( options ){
    ...
    this.addLineBreak = options.addLineBreak !== undefined ? options.addLineBreak : true;

    // xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    // TODO: Deprecate this...currently this exists for older version:
    if(options.showFullStackTrace === true){ this.showStackTrace = true; }
    // xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
